...
class NotificationService {
  ...
  static Future init() async {
    ...
    try {
      ...
      // 🛠️ FIX: was '@mipmap/ic_launcher' (default Flutter logo drawable),
      // which is why the app icon didn't show in notifications. The real
      // SOLO icon generated by flutter_launcher_icons lives in
