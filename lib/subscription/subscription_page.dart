...
class _SubscriptionPageState extends State<SubscriptionPage> {
  ...
  final List<Map<String, dynamic>> _plans = [
    ...
    },
    {
      ...
      "benefits": ["1 Alert Credit", "Add 1 contact", "First-time users only"],
      "progress": 0.9,
      "priceId": "price_1TZ8zgH682jITs1wzNptVVi0", // Monthly Price ID passed for 7-day trial auto-renewal
    },
    {
      "id": "yearly",
      "big": "1",
  ...
  void initState() {
    ...
    const int startFactor = 1000;
    int initialPage = (_plans.length * startFactor) + 1; // Index 1 is Trial
    _pageController = PageController(
      viewportFraction: 0.5,
      initialPage: initialPage,
    );
