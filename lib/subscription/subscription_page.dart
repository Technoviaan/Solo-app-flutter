...
class _SubscriptionPageState extends State<SubscriptionPage> {
  ...
  int _credits = 1; // Default 1 set kiya
  ...
  Future<void> _loadPromoState() async {
    ...
    setState(() {
      ...
      // Agar storage me data na ho ya 0 ho (starter plan ke case me) to default 1 show hoga
...
//   double _currentPage = 1.0;
//
//   // Har card ke credits 'planCredits' me set kiye gaye hain
//   final List<Map<String, dynamic>> _plans = [
//     {
//       "id": "monthly",
//       "big": "1",
...
//     _currentPage = initialPage.toDouble();
//
//     // Scroll listener jo card slide hone par live rebuild karega
//     _pageController.addListener(() {
//       if (mounted) {
//         setState(() {
//           _currentPage = _pageController.page ?? initialPage.toDouble();
...
//
//     const String displayHeaderTitle = "Available\nCredits";
//     final String displaySubtitle = isTopupFocused ? "Instant Topup" : "This Plan";
//
//     // 👉 Yahan focused card ke credits display ho rahe hain
//     final int focusedCardCredits = activePlan["planCredits"] ?? 1;
//     final String mainDisplayValue = "$focusedCardCredits";
//
//     String planLabel = "${activePlan['big']} ${activePlan['title'].toString().replaceAll('\n', ' ')}";
//     String? renewalText;
//
//     if (_activePromoPlan != null) {
//       planLabel = _activePromoPlan!;
...
//                             const SizedBox(height: 16),
//
//                             // 👉 AVAILABLE CREDITS CONTAINER (Focused Card Value Dikhane Wala Section)
//                             Padding(
//                               padding: const EdgeInsets.symmetric(horizontal: 6),
//                               child: Column(
//                                 crossAxisAlignment: CrossAxisAlignment.start,
...
//                                                 child: Text(
//                                                   mainDisplayValue,
//                                                   key: ValueKey<String>(mainDisplayValue),
//                                                   textAlign: TextAlign.center,
//                                                   style: TextStyle(
//                                                     color: const Color(0xFFA8B6C2),
//                                                     fontSize: dynamicFontSize,
